...
export const LazyLoader = React.memo<LazyLoaderProps>(({
  component,
  fallback = <LoadingSpinner isVisible={true} status="Ładowanie komponentu..." />,
  props = {}
}) => {
...
export const LazyLoaderWithErrorBoundary = React.memo<LazyLoaderProps & {
...
export const IntersectionLazyLoader = React.memo<LazyLoaderProps & {
  threshold?: number;
  rootMargin?: string;
}>(({
  component,
