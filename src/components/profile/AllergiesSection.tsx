    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-3 pb-2">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">{getCategoryDescription("allergy")}</p>
        </div>
      </div>

      {/* Selected Count */}
      {selectedAllergyPreferences.length > 0 && (
        <div className="text-sm text-muted-foreground">Wybrano: {selectedAllergyPreferences.length} ograniczeń</div>
      )}
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              <p>
                • AI stara się unikać wybranych składników, ale <strong>nie może zagwarantować</strong> całkowitego
                braku alergenów
              </p>
              <p>• Zawsze sprawdzaj składniki przed przygotowaniem posiłku</p>
              <p>• W przypadku poważnych alergii skonsultuj się z lekarzem przed wprowadzeniem nowych produktów</p>
            </div>
          </div>
        </div>
      </div>
