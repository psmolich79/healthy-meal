...
export const AnimatedAccordion: React.FC<AnimatedAccordionProps> = React.memo(
  ({ title, description, icon, isExpanded, onToggle, children, className }) => {
    return (
      <motion.div
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <motion.span className="text-xl" animate={{ rotate: isExpanded ? 0 : 0 }} transition={{ duration: 0.2 }}>
                {icon}
              </motion.span>
              <div>
