  ...
  return (
    <div className={`space-y-3 ${className}`}>
      ...
      <div className="flex items-center space-x-2">
        <span className="text-sm font-medium text-muted-foreground">Oceń przepis:</span>
        ...
        <div className="flex items-center space-x-1">
          ...
          >
            ...
            <span className={`ml-1 text-xs ${isUpSelected ? "text-white" : "text-green-600"}`}>Podoba mi się</span>
          </Button>
          ...
          <Button
            ...
            disabled={disabled || isLoading}
            className={`transition-all ${
              isDownSelected ? "bg-red-600 hover:bg-red-700 border-red-600" : "hover:bg-red-50 hover:border-red-300"
            }`}
          >
            ...
            <span className={`ml-1 text-xs ${isDownSelected ? "text-white" : "text-red-600"}`}>Nie podoba mi się</span>
          </Button>
      ...
      {showConfirmation && isDownSelected && (
        <Alert>
          <AlertDescription>
            Dzięki za opinię! Jeśli przepis Ci się nie podoba, możesz wygenerować nową wersję używając przycisku
            "Wygeneruj ponownie" poniżej.
          </AlertDescription>
        </Alert>
      )}
