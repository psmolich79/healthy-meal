...
export const FilterToggle: React.FC<FilterToggleProps> = React.memo(({
  ...
  }, [options, onFilterChange, disabled]);

  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      <span className="text-sm font-medium text-muted-foreground whitespace-nowrap">Filtruj:</span>

      <Select value={currentFilter.value} onValueChange={handleFilterChange} disabled={disabled}>
